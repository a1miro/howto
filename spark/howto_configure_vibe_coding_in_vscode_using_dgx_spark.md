...
Follow these [instructions](https://build.nvidia.com/spark/vibe-coding/instructions) to configure Vibe Coding in VSCode using a DGX Spark as the Ollama model host.
